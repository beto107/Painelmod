...
```sh
sudo apt install wget -y; wget https://raw.githubusercontent.com/beto107/painelMod/main/i.sh; chmod 777 i.sh; ./i.sh
```
...
```sh
git clone https://github.com/beto107/painelMod.git
```
